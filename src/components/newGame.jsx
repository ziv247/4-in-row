    ...
    render(){
        return(
            <div style={newGameWrapperStyle}>
                ...
                <form action="">
                    <h3 style={{marginBottom:'15px'}}>Would you like to play another game?</h3>
                    <div style={{display:'flex',justifyContent:'space-around',marginBottom:'15px'}}>
                        <Button value='yes' variant="secondary" size="sm">Yes</Button>
                        <Button value='no' variant="secondary" size="sm">No</Button>
